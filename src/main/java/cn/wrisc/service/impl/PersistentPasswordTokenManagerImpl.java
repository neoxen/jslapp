...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see cn.wrisc.service.impl.PasswordTokenManager#generateRecoveryToken(cn.wrisc.model.User)
     */
    @Override
    ...
    /**
     * @see cn.wrisc.service.impl.PasswordTokenManager#isRecoveryTokenValid(cn.wrisc.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see cn.wrisc.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
