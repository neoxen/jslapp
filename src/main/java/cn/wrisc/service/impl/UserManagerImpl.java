...
import cn.wrisc.dao.UserDao;
import cn.wrisc.model.User;
import cn.wrisc.service.MailEngine;
import cn.wrisc.service.UserExistsException;
import cn.wrisc.service.UserManager;
import cn.wrisc.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "cn.wrisc.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see cn.wrisc.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
